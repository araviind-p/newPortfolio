      ...
      <div className="flex flex-col items-center text-center space-y-6 md:space-y-8 lg:space-y-10">
        ...
        <div className="flex flex-col space-y-4 md:space-y-6 lg:space-y-8">
          <a href="#about" className="w-full">
            <div
              className={`flex items-center justify-center px-6 py-3 ${darkMode ? 'bg-button-dark text-text-dark hover:bg-button-dark-hover' : 'bg-button-light text-text-light hover:bg-button-light-hover'
          ...
          <a href="#contact" className="w-full">
            <div
              className={`flex items-center justify-center px-6 py-3 ${darkMode ? 'bg-button-dark2 text-text-dark hover:bg-button-dark2-hover' : 'bg-button-light2 text-text-light hover:bg-button-light2-hover'
                } rounded-md shadow-md transition duration-300 cursor-pointer`}
            >
