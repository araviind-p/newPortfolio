...
const About = () => {
    return (
        <>
            <div id="about" className="bg-[#1F2937] text-gray-200 min-h-screen w-full overflow-x-hidden">
                <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <a
                        ...
                        className="inline-block mt-4 px-6 py-3 bg-[#04195f] text-gray-200 rounded-md shadow-md hover:bg-gray-200 hover:text-[#04195f] transition duration-300"
                    >
